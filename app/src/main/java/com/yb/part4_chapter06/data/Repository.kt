package com.yb.part4_chapter06.data

import com.google.gson.GsonBuilder
import com.yb.part4_chapter06.BuildConfig
import com.yb.part4_chapter06.data.services.KakaoLocalApiService
...
object Repository {
    ...
    suspend fun getNearByMonitoringStation(latitude: Double, longitude: Double) {
        val tmCoordinates = kakaoLacalApiService.getTmCoordinates(longitude, latitude)
            .body()
            ?.documents
            ?.firstOrNull()
